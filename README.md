...
The input is a pooled set of 5,486 BioASQ Task B questions from multiple challenge years. Questions repeated in different years remain separate when their gold paper set or publication cutoff differs. Each API request excludes papers published after that question's BioASQ challenge year.
...
Claude Opus 4.8 generated 16,353 queries. GPT-5.6 Sol generated 105 replacements for Opus refusals and later repaired provider-rejected syntax in 83 of the Opus-generated queries. Repair prompts include the rejected query and validation error. For 164 Semantic Scholar queries, `request_query_used` differs from `generated_query` because unsupported hyphens were replaced with spaces before the API request.
